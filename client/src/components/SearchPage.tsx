...
import { PageProps, MyIngredientsProps } from '../interfaces/Props'
...
export default function SearchPage({user, setUser, page, setPage}: PageProps) {
  ...
  if(user.username) return (
    <div className='list-page'>
      ...
      <MyIngredients className='' selectedIngs={selectedIngs} setSelectedIngs={setSelectedIngs}
      ...
      user={user} setUser={setUser} setPage={setPage}/>}
    </div>
  )
  return (
    <div className='list-page'>
      ...
      <Navbar className= '' selectedIngs={selectedIngs} handleAddToSelected={handleAddToSelected}
      ingredients={ingredients} categories={categories}/>

      <MyIngredients className='MyIngredients' selectedIngs={selectedIngs} setSelectedIngs={setSelectedIngs}
      handleRemoveFromSelected={handleRemoveFromSelected} setIngredients={setIngredients}/>

      {cocktails.length && <CocktailList page='' setPage={setPage} selectedIngs={selectedIngs} cocktails={cocktails}
